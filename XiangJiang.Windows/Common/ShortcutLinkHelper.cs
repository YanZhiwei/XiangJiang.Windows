...
namespace XiangJiang.Windows.Common
{
    ...
    ///     创建快捷方式
    /// </summary>
    public sealed class ShortcutLinkHelper
    {
        #region Methods
        ...
        public static string CreateCurUserDesktop(string name, string programPath, string description)
        {
        ...
        /// <param name="description">快捷方式描述</param>
        /// <returns></returns>
        public static string CreateCurUserStartup(string name, string programPath, string description)
        {
        ...
        /// <param name="programPath">程序路径</param>
        /// <param name="description">快捷方式描述</param>
        public static string Create(string shortcutFolder, string shortcutName, string programPath, string description)
        {
            Checker.Begin().NotNullOrEmpty(shortcutName, nameof(shortcutName))
            ...
            var shortcutLink = Path.Combine(shortcutFolder, $"{shortcutName}.lnk");
